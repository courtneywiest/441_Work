function adventurestory(choice) {
    var option1 = document.getElementById("yes").innerHTML;
    var option2 = document.getElementById("no").innerHTML;
    ...
    if (choice == 1 && option1 == "Open the letter on the desk") {
            ...
            document.getElementById("yes").innerHTML = "Go west towards the Forest";
            document.getElementById("no").innerHTML = "Search this area";
          }
    ...
    { document.getElementById("beginning").innerHTML = "You go back to the main room in your house, and fall asleep on the couch";
      document.getElementById("no").innerHTML = "end";
      ////////is this right???////
    }
    ...
    else if (choice == 1 && option1 == "Search this area")
    {
      ...
      document.getElementById("yes").innerHTML = "Um, sure";
    ...
    {   document.getElementById("beginning").innerHTML = "You search around the area and find a strange glowing crystal lying on the ground.";
        document.getElementById("yes").innerHTML = "Inspect the crystal";
        document.getElementById("no").innerHTML = "Leave the crystal";
    }
    ...
    { document.getElementById("beginning").innerHTML = "You go back home and don't help the wizard. the end.";
      ...
      document.getElementById("yes").innerHTML = "Go back home";
      document.getElementById("no").innterHTML = "Explore the forest more";
    }
    ...
    else if (choice 2 == option2 == "Explore the forest more") {
